...
meta.json 训练必需字段仅 3 个：camera.intrinsics、camera.extrinsics_c2w、resolution。其余 10 个字段均为构建脚本溯源/调试元数据。
index.json clips 字段
字段
训练是否使用
结论
